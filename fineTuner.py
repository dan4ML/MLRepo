...
def fine_tune_t5_model(model, tokenizer, train_data, val_data, learning_rate=5e-5, epochs=15, batch_size=16, accumulation_steps=16):
...
if __name__ == "__main__":
    ...
    output_dir = "/MainML/eagle/ImageData/LLM/T5-3B-FINETUNED"
    ...
    '''note from nick:
    from Nickolas Dodd to everyone in this session:    5:36 PM
    tqdm
    from Nickolas Dodd to everyone in this session:    5:37 PM
    from tqdm import tqdm
    from Nickolas Dodd to everyone in this session:    5:37 PM
    And then wrap your iterables with tqdm()
    '''
